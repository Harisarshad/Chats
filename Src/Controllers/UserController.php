...
class UserController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        $htmldata = view('Chats::layouts.tabpane-contact-list')->with('contacts', $contacts)->render();
    ...
    public function recentsearch(Request $request)
    {
        if ($request->ajax()) {
            ...
            $htmldata = view('Chats::layouts.tabpane-recent-contact-list')->with('users', $users)->render();
            return Response($htmldata);
        }
    }
    ...
    public function messagesearch(Request $request)
    {
        if ($request->ajax()) {
            ...
            $htmldata = view('Chats::layouts.message-conversation')->with(['messages' => $messages])->with(['chatUser' => $chatUser])->render();
            return Response($htmldata);
        }
    }
}
