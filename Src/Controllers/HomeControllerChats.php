<?php
namespace Modules\Chats\Src\Controllers; // Make sure this matches exactly
...
class HomeControllerChats extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('Chats::index')->with(['users' => $users, 'contacts' => $contacts, 'groupdata' => $groupdata, 'AttachedFiles' => $AttachedFiles]);
    }
    ...
    public function getMessage($user_id)
    {
        ...
        return [
            'view1' => view('Chats::layouts.chat-message-data')->with(['messages' => $messages])->with(['chatUser' => $chatUser])->render(),
            'view2' => view('Chats::layouts.user-profile-details')->with(['messages' => $messages])->with(['chatUser' => $chatUser])->render()
        ];
    }
