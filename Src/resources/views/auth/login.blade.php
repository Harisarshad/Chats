        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="text-center mb-4">
                    ...
                    <h4>{{ __("Sign in") }}</h4>
                    <p class="text-muted mb-4">{{ __("Sign in to continue to CHAT.") }}</p>
                </div>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3 bg-soft-light input-group-lg rounded-lg">
                                        ...
                                        <input id="email" type="email" class="form-control bg-soft-light border-light @error('email') is-invalid @enderror" name="email" value="{{ old('email', 'haris.arshad.2010@gmail.com') }}" required autocomplete="email" autofocus placeholder="{{ __("Enter Email") }}">
                                        @error('email')
                ...
                <div class="mt-5 text-center">
                    ...
                    <p>{{ __("© 2020 CHAT. Crafted with") }}<i class="mdi mdi-heart text-danger"></i>Haris Arshad</p>
                </div>
            </div>
        </div>
    </div>
