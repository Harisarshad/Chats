                ...
                @else
                    @foreach ($userdata as $item)
                        @if (($message->from_user_id== $item->id))
                            <img src="{{(!empty($item->avatar))?  \Modules\Chats\Src\Models\Group::get_file($item->avatar): asset(Storage::url("uploads/avatar/avatar.png"))}}" alt="" class="imgavatar">
                        @endif
                    @endforeach
                @endif
            </div>
                                ...
                                <div class="media-body">
                                    <div class="text-left">
                                        ...
                                        <p class="text-muted font-size-13 mb-0">
                                            @php
                                                echo Modules\Chats\Src\Controllers\HomeControllerChats::bytesToHuman(File::size(public_path($message->file)));
                                            @endphp
                                        </p>
                                    </div>
                                </div>
